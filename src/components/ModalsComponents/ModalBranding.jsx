...
import animationBranding from "../../assets/lotties/branding-full.json";
import ContainerRightModal from "../ContainerRightModal";
import MailTo from "../MailTo";
import Button from "../Button";

const ModalBranding = ({ isOpen, closeModal }) => {
  return (
    <>
      <ContainerModal>
          ...
          <div className="container-modal-branding-description-right">
            <div className="container-modal-branding-description-first">
              <div className="content-description-branding">
                ...
                <p className="modal-branding-description">
                  We get to know each other and set the objectives of your
                  brand.
                </p>
              </div>
              <div className="content-description-branding">
              ...
              <div className="content-description-branding">
                ...
                <p className="modal-branding-description">
                  The brand survey is a tool that we use to get to know each
                  other a little more. It is considered before starting the
                  design of your brand identity. It is a very important kick for
                  us, helping us to reach our short-term goals.
                </p>
              </div>
            </div>
            <div className="container-modal-branding-description-two">
              <div className="content-description-branding">
                ...
                <p className="modal-branding-description">
                  Finding the desired path is not something simple. That is why
                  at first we will present you with several proposals, of which
                  the selected one will give the foot to your complete graphic
                  system.
                </p>
              </div>
              <div className="content-description-branding">
              ...
              <div className="content-description-branding">
                <p className="modal-branding-description-title">
                  <span className="modal-branding-count">6</span>All ready to
                  rock
                </p>
                <p className="modal-branding-description">
